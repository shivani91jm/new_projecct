...
class MenuControllers extends GetxController{
  ...
  void dataCategoriesById(String cat_id) async{
    ...
    var consumer_key=prefs.getString('shop_consumer_key')??"";
    var consumer_secreate=prefs.getString('shop_consumer_secrete')??"";
    var urls=shopUrl+BaseUrlsClass.productCatUrls+cat_id+"&consumer_key="+consumer_key+"&consumer_secret="+consumer_secreate;
